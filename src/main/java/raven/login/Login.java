...
public class Login extends JPanel {
    ...
    private void init() {
        ...
        JLabel lbTitle = new JLabel("Sistema de Laço");
        JLabel description = new JLabel("Informe suas credenciais de acesso");
    ...
    private Component createSignupLabel() {
        ...
        panel.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:null");
        JButton cmdRegister = new JButton("<html><a href=\"#\">Criar conta</a></html>");
        ...
        JLabel label = new JLabel("Nãp possui uma conta ?");
